...
for (i, file_name) in enumerate(outcomes)
    if occursin("config_file_1", file_name)
...
img = PNG("./data/Plots/config_file_1_Rastrigin.png", 6inch, 4inch)
draw(img, p);

best_f_value = CSV.File("./data/Outcomes/config_file_1_Rastrigin_14:34:33.csv") |> DataFrame
...
img = PNG("./data/Plots/config_file_1_Rastrigin_best_f_value.png", 6inch, 6inch)
draw(img, p)


worst_f_value = CSV.File("./data/Outcomes/config_file_1_Rastrigin_14:29:02.csv") |> DataFrame
...
img = PNG("./data/Plots/config_file_1_Rastrigin_worst_f_value.png", 6inch, 6inch)
draw(img, p)
