...
function hatchery(population_model, population)
    ...
    population_for_each_caste= _get_number_of_population_for_each_caste(population_model)
    population_in_castes = _divide_population_in_castes(population, population_for_each_caste)

    _assert_population_divided_in_castes_match_initial_population_size(population_in_castes, population_length)
    return population_in_castes
end

function _get_number_of_population_for_each_caste(population_model)
...
function _divide_population_in_castes(population, population_for_each_caste)
...
function _assert_population_divided_in_castes_match_initial_population_size(castes, population_length)
